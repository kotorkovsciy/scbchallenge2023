import requests
from .pars_data import (
    get_region,
    get_city_byRegion,
    get_countries,
    get_republics_by_country,
    get_cities_by_republic,
    get_cities_by_republics,
    get_republics_by_country_n_republics_ids,
...
class JsonParser:
    ...
    def get_republics_by_country_n_republics_ids(self, country_id, republics_id):
        return get_republics_by_country_n_republics_ids(
            country_id, republics_id, self.data
        )
